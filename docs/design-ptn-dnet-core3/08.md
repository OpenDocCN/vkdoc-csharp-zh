...
![img/476082_2_En_8_Chapter/476082_2_En_8_Figa_HTML.jpg](img/476082_2_En_8_Chapter/476082_2_En_8_Figa_HTML.jpg)
...
也要注意文件名。这很重要:每种类型都在自己的文件中。现在，当您运行这个程序时，假设您想在不停止应用程序的情况下更改`Log`的实现。您要做的如下所示:
