...
![../images/476082_2_En_3_Chapter/476082_2_En_3_Figa_HTML.jpg](../images/476082_2_En_3_Chapter/476082_2_En_3_Figa_HTML.jpg)
...
而`PersonBuilderExtensions`类保持原样。使用这种方法，您可以轻松地重用`FunctionalBuilder`作为应用程序中其他函数构建器的基类。请注意，在函数范式下，我们仍然坚持派生的构建器都是`sealed`并通过使用扩展方法来扩展的想法。
