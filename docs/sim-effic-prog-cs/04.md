...
> *SOLID原则不是规则。它们不是法律。它们不是完美的真理。它们是类似于“一天一个苹果，医生远离我”的陈述这是一个很好的原则，很好的建议，但它不是一个纯粹的真理，也不是一条规则。*
> 
> —鲍勃大叔
...
SOLID原则是面向对象设计的基本准则。这些高层次的概念可以帮助你做出更好的软件。它们既不是规则，也不是法律，但它们可以帮助你提前想到可能的情景/结果。
